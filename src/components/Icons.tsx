...
const paths: Record<IconName, React.ReactNode> = {
  ...
  zzz: (
    <>
      <path d="M4.5 9.5h6l-6 7h6" />
      <path d="M14.5 5h5l-5 6h5" />
      <path d="M15 17.5h4l-4 4.5h4" transform="scale(0.9) translate(1.5 -1)" />
    </>
  ),
  spa: (
    <>
      <path d="M12 16.5c-2-1.3-3-3-3-4.9C9 9.9 10 8.3 12 7c2 1.3 3 2.9 3 4.6 0 1.9-1 3.6-3 4.9z" />
      <path d="M12 16.5c-3.1.4-5.7-.4-7.4-2.4 1.6-1.1 3.4-1.5 5.2-1.2" />
      <path d="M12 16.5c3.1.4 5.7-.4 7.4-2.4-1.6-1.1-3.4-1.5-5.2-1.2" />
      <path d="M7 19c3.2 1.2 6.8 1.2 10 0" />
    </>
  ),
  "chat-heart": (
    <>
      <path d="M12 4.5c4.4 0 7.8 2.8 7.8 6.4S16.4 17.4 12 17.4c-.8 0-1.6-.1-2.4-.3L5.2 19l.9-3.1c-1.2-1.2-1.9-2.7-1.9-4.9 0-3.7 3.4-6.5 7.8-6.5z" />
      <path
        d="M12 13.7c-1.7-1.2-2.6-2.3-2.6-3.4 0-.9.7-1.6 1.6-1.6.4 0 .7.1 1 .4.3-.3.6-.4 1-.4.9 0 1.6.7 1.6 1.6 0 1.1-.9 2.2-2.6 3.4z"
        fill="currentColor"
        stroke="none"
      />
    </>
  ...
  gift: (
    <>
      <rect x="4.5" y="10.5" width="15" height="9" rx="1.8" />
      <path d="M4 7.5h16v3H4z" />
      <path d="M12 7.5V19.5" />
      <path d="M12 7.5c-1.9 0-3.6-.8-3.6-2.2 0-1.1.9-1.8 1.8-1.8 1.6 0 2.3 1.9 1.8 4zm0 0c1.9 0 3.6-.8 3.6-2.2 0-1.1-.9-1.8-1.8-1.8-1.6 0-2.3 1.9-1.8 4z" />
    </>
  ),
  camera: (
    <>
